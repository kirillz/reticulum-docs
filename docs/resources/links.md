...
# Безопасность (алерты будут здесь)
⚠️ Пока нет данных :smiley:  
...
[Обзорная статья на Хабре](https://habr.com/ru/companies/globalsign/articles/662489/)  
[Сборник ссылок](https://github.com/lorien/awesome-reticulum)  
[4PDA](https://4pda.to/forum/index.php?showtopic=1114849)
...
[RetiBBS](https://github.com/kc1awv/RetiBBS)  
[rBrowser](https://github.com/fr33n0w/rBrowser)  
[Columba](https://github.com/torlando-tech/columba)  
[MeshchatX](https://git.quad4.io/RNS-Things/MeshChatX)  
[Runcore (IOS)](https://github.com/svanichkin/runcore)  

### Железо и прошивки:
[RNode обычная](https://github.com/markqvist/RNode_Firmware)   
[RNode CE](https://github.com/liberatedsystems/RNode_Firmware_CE)  
